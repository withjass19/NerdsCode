    ...
    <main>
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row mb-5 py-5 java" style="margin-top:-45%">
                    <div class="col text-white text-center py-5">
                        <p class="fs-1 fw-bold">Java Programming</p>
                        ...
                        <button type="button" class="btn btn-outline-warning px-5 py-2 fw-medium border-2 rounded-pill"> 
                           <a href="javastart">Start Course</a> </button>
                    </div>
                </div>
                <div class="row p-3">
                    <div class="col">
                ...
                <div class="row p-5 pt-0 bg-white start-java2" style="top: 85%">
                    ...
                    <div class="col-7 pt-5 ps-4">
                        <div class="row">
                            <div class="col ps-4">
                                <p class="fs-4 fw-semibold">Getting Started with Java</p>
